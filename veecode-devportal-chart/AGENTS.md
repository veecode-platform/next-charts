# veecode-devportal chart (1.x)

Instructions for the 1.x chart in this directory. The repository router is [../AGENTS.md](../AGENTS.md). Run its commands from the repository root.
